...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { song_id: @rate.song_id, user_id: @rate.user_id, value: @rate.value } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { song_id: @rate.song_id, user_id: @rate.user_id, value: @rate.value } }
