...
class StocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stock" do
    assert_difference('Stock.count') do
      post stocks_url, params: { stock: { product: @stock.product, quantity: @stock.quantity } }
    end
  ...
  test "should update stock" do
    patch stock_url(@stock), params: { stock: { product: @stock.product, quantity: @stock.quantity } }
